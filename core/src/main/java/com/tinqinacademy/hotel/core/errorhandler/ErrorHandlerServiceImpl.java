...
import com.tinqinacademy.hotel.core.exceptions.HotelValidationException;
import io.vavr.API;
...
public class ErrorHandlerServiceImpl implements ErrorHandlerService {
    ...
    public ErrorWrapper handle(Throwable throwable) {
        return Match(throwable).of(
                API.Case(API.$(instanceOf(HotelApiException.class)), this::handleHotelApiException),
                API.Case(API.$(instanceOf(HotelValidationException.class)), this::handleHotelValidationException),
